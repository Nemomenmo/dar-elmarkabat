    ...
    },
   {
    ...
    },
    {
        ...
        instructions: [
            ...
            "في حالة بدء الاشتراك للسباحة خلال الشهر، يحسب عدد الحصص المتبقية مع زيادة 10% ولا يطبق على الفرق.",
            "أبناء العاملين بالدار يحاسبون بسعر المركبات.",
            ...
            "التدريب الخاص للسباحة متاح من 4:30م إلى 5:30م فقط."
        ],
        ...
        pricing: [
            {
                ...
                tiers: [
                    ...
                    { name: "سباحة: 10 أفراد تجهيزي B", time: "يومين في الأسبوع (ساعة)", price: "800", priceLabel: "اشتراك شهري" },
            ...
            },
            {
                ...
                tiers: [
                    ...
                    { name: "سباحة: 10 أفراد تجهيزي B", time: "يومين في الأسبوع (ساعة)", price: "750", priceLabel: "اشتراك شهري" },
            ...
            },
            {
                ...
                tiers: [
                    ...
                    { name: "سباحة: 10 أفراد تجهيزي B", time: "يومين في الأسبوع (ساعة)", price: "700", priceLabel: "اشتراك شهري" },
